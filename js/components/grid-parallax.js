...
(function(addon) {
    ...
    if (typeof define == 'function' && define.amd) {
        define('uidata-grid-parallax', ['uidata'], function(){
    ...
    UI.component('gridparallax', {
        ...
        boot: function() {
            ...
            UI.$doc.on('scrolling.ud.document', checkParallaxes);
            ...
            UI.ready(function(context) {
                ...
                UI.$('[data-ud-grid-parallax]', context).each(function() {

                    var parallax = UI.$(this);

                    if (!parallax.data('gridparallax')) {
                        UI.gridparallax(parallax, UI.Utils.options(parallax.attr('data-ud-grid-parallax')));
                    }
                });
            });
        },
    ...
    function percentageInViewport(element) {
        ...
        var top       = element.offset().top,
            ...
            scrolltop = UIData.$win.scrollTop(),

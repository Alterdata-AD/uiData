...
(function(addon) {
    ...
    if (typeof define == 'function' && define.amd) {
        define('uidata-pagination', ['uidata'], function(){
    ...
    UI.component('pagination', {
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$('[data-ud-pagination]', context).each(function(){
                    var ele = UI.$(this);

                    if (!ele.data('pagination')) {
                        UI.pagination(ele, UI.Utils.options(ele.attr('data-ud-pagination')));
                    }
                });
            });
        },
        ...
        selectPage: function(pageIndex, pages) {
            ...
            this.trigger('select.ud.pagination', [pageIndex, this]);
        },
        ...
        _append: function(pageIndex, opts) {
            ...
            item = (pageIndex == this.currentPage) ? '<li class="ud-active"><span>' + (options.text) + '</span></li>' : '<li><a href="#page-'+(pageIndex+1)+'" data-page="'+pageIndex+'">'+options.text+'</a></li>';

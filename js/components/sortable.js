...
(function(addon) {
    ...
    if (typeof define == 'function' && define.amd) {
        define('uidata-sortable', ['uidata'], function(){
    ...
    UI.component('sortable', {
        ...
        defaults: {
            ...
            childClass       : 'ud-sortable-item',
            placeholderClass : 'ud-sortable-placeholder',
            overClass        : 'ud-sortable-over',
            draggingClass    : 'ud-sortable-dragged',
            dragMovingClass  : 'ud-sortable-moving',
            baseClass        : 'ud-sortable',
            noDragClass      : 'ud-sortable-nodrag',
            emptyClass       : 'ud-sortable-empty',
            dragCustomClass  : '',
            handleClass      : false,
            group            : false,
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$('[data-ud-sortable]', context).each(function(){

                    var ele = UI.$(this);

                    if(!ele.data('sortable')) {
                        UI.sortable(ele, UI.Utils.options(ele.attr('data-ud-sortable')));
                    }
                });
            });
        ...
        dragStart: function(e, elem) {
            ...
            delayIdle = {
                ...
                apply     : function(evt) {
                    ...
                    $this.trigger('start.ud.sortable', [$this, currentlyDraggingElement, draggingPlaceholder]);
        ...
        dragEnd: function(e, elem) {
            ...
            if (currentlyDraggingElement) {
                ...
                this.trigger('stop.ud.sortable', [this]);
            }
        ...
        triggerChangeEvents: function() {
            ...
            triggers.forEach(function (trigger, i) {
                if (trigger.sortable) {
                    trigger.sortable.element.trigger('change.ud.sortable', [trigger.sortable, el, trigger.mode]);
                }
            });
        },

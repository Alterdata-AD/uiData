...
(function(addon) {
    ...
    if (typeof define == 'function' && define.amd) {
        define('uidata-nestable', ['uidata'], function(){
    ...
    UI.component('nestable', {
        ...
        defaults: {
            listBaseClass   : 'ud-nestable',
            listClass       : 'ud-nestable-list',
            listItemClass   : 'ud-nestable-item',
            dragClass       : 'ud-nestable-dragged',
            movingClass     : 'ud-nestable-moving',
            noChildrenClass : 'ud-nestable-nochildren',
            emptyClass      : 'ud-nestable-empty',
            handleClass     : '',
            collapsedClass  : 'ud-collapsed',
            placeholderClass: 'ud-nestable-placeholder',
            noDragClass     : 'ud-nestable-nodrag',
            group           : false,
            maxDepth        : 10,
            threshold       : 20,
            idlethreshold   : 10,
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$("[data-ud-nestable]", context).each(function(){

                    var ele = UI.$(this);

                    if (!ele.data("nestable")) {
                        UI.nestable(ele, UI.Utils.options(ele.attr("data-ud-nestable")));
                    }
                });
            });
        },
        ...
        init: function() {
            ...
            var onStartEvent = function(e) {
                ...
                $this.delayMove = function(evt) {
                    ...
                    evt.preventDefault();
                    $this.dragStart(e);
                    $this.trigger('start.ud.nestable', [$this]);
            ...
            var onMoveEvent = function(e) {
                ...
                if ($this.dragEl) {
                    e.preventDefault();
                    $this.dragMove(e);
                    $this.trigger('move.ud.nestable', [$this]);
                }
            };
        ...
        setParent: function(li) {
            ...
            if (li.children(this.options._listClass).length) {
                li.addClass('ud-parent');
            }
        },

        unsetParent: function(li) {
            li.removeClass('ud-parent '+this.options.collapsedClass);
        ...
        dragStop: function(e) {
            ...
            if (this.element[0] !== root[0]) {
                ...
                root.trigger('change.ud.nestable',[root.data('nestable'), el, 'added']);
                this.element.trigger('change.ud.nestable', [this, el, 'removed']);

            } else {
                this.element.trigger('change.ud.nestable',[this, el, "moved"]);
            }

            this.trigger('stop.ud.nestable', [this, el]);
